...
class ScannerDB:
    def __init__(self, database_url=None):
        ...
        self.connection_pool = pool.SimpleConnectionPool(1, 10, self.database_url)
    ...
    def insert_findings(self, regions, findings):
                ...
                for finding in findings:
                    cur.execute(
                        ...
                        INSERT INTO findings (
                            scan_run_id, resource_id, resource_type, region,
                            reason, monthly_cost_usd, monthly_cost_inr, tags, detected_at
    ...
    def resolve_finding(self, resource_id):
        with self.get_connection() as conn:
            with conn.cursor() as cur:
                cur.execute(
                    """
    ...
    def get_waste_trend(self, weeks=12):
        with self.get_connection() as conn:
            with conn.cursor() as cur:
                cur.execute(
                    """
